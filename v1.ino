...
const uint8_t SRC_ID     = 0x01;  // follower Arduino ID tag
...
Encoder encT5(ENCODER_PIN_1, ENCODER_PIN_2);
...
// Function prototypes.
void sendCountsToMasterArduino(int countsT5);
...
void loop()
{
  ...
  sendCountsToMasterArduino(countsT5);
